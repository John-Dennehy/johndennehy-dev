					...
					<div className="flex flex-col md:flex-row items-start gap-10 md:gap-16">
						...
						<div className="space-y-5">
							...
							<p className="animate-slide-up stagger-1 text-lg md:text-xl text-text-secondary font-medium">
								Frontend &amp; Full-Stack Developer <span className="text-text-muted">·</span>{' '}
							...
							<p className="animate-slide-up stagger-2 max-w-xl text-text-secondary leading-relaxed">
								Returning to development after a career that&apos;s taken a few interesting turns —
								a decade in financial services, a bootcamp pivot, three years building products in
					...
					<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
						...
						<div className="glass-card p-6 animate-slide-up stagger-3">
							<div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-accent/10 text-accent">
								...
								>
									<title id="frontend-dev-title">Frontend Development icon</title>
									<path
										strokeLinecap="round"
										strokeLinejoin="round"
							...
							<p className="text-sm text-text-secondary leading-relaxed">
								...
								Next.js&nbsp;16, modern CSS, and the component patterns that have evolved while I
								was away.
							</p>
						</div>
						...
						<div className="glass-card p-6 animate-slide-up stagger-4">
							<div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-accent-secondary/10 text-accent-secondary">
								<svg
									...
									strokeWidth={1.5}
									role="img"
									aria-labelledby="fullstack-arch-title"
								>
									<title id="fullstack-arch-title">Full-stack Architecture icon</title>
									<path
										strokeLinecap="round"
										strokeLinejoin="round"
							...
							<h3 className="text-base font-semibold text-text-primary mb-2">Full-Stack Capable</h3>
							<p className="text-sm text-text-secondary leading-relaxed">
								Comfortable working end-to-end. This site runs on Payload&nbsp;CMS and
								Neon&nbsp;Postgres — I enjoy understanding the full picture, from database schema to
								deployed product.
							</p>
						</div>
						...
						<div className="glass-card p-6 animate-slide-up stagger-5">
							<div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-accent/10 text-accent">
								...
								>
									<title id="employability-title">Employability Coaching icon</title>
									<path
										strokeLinecap="round"
										strokeLinejoin="round"
							...
							<h3 className="text-base font-semibold text-text-primary mb-2">Not Just Code</h3>
							<p className="text-sm text-text-secondary leading-relaxed">
								Ten years managing complaints in financial services taught me to listen, communicate
								clearly, and solve problems under pressure. A year coaching others sharpened that
								further. I write code, but I understand people too.
							</p>
						</div>
					</div>
				</div>
			...
			<section className="px-6 md:px-8 py-16 md:py-24">
				<div className="mx-auto max-w-5xl">
					...
					<p className="animate-slide-up stagger-4 text-text-secondary mb-10 max-w-xl">
						I&apos;m looking for frontend or full-stack roles and always happy to chat. Find me on
						any of these.
					</p>
					...
					<div className="flex flex-wrap gap-4 animate-slide-up stagger-5">
						...
						>
							...
							<svg
								className="w-4 h-4 ml-2 text-text-muted group-hover:text-accent group-hover:translate-x-1 transition-all"
								fill="none"
								viewBox="0 0 24 24"
								stroke="currentColor"
								strokeWidth={2}
								role="img"
								aria-labelledby="github-link-title"
							>
								<title id="github-link-title">Go to GitHub profile</title>
								<path
									strokeLinecap="round"
									strokeLinejoin="round"
						...
						>
							<svg
								...
								viewBox="0 0 24 24"
								role="img"
								aria-labelledby="linkedin-link-title-home"
							>
								<title id="linkedin-link-title-home">LinkedIn</title>
							...
							<svg
								...
								strokeWidth={2}
								role="img"
								aria-labelledby="linkedin-go-title"
							>
								<title id="linkedin-go-title">Go to LinkedIn profile</title>
								<path
									strokeLinecap="round"
									strokeLinejoin="round"
									d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"
						...
						>
							...
							>
								<title id="x-icon-title">X (formerly Twitter)</title>
							...
							<svg
								...
								strokeWidth={2}
								role="img"
								aria-labelledby="x-go-title"
							>
								<title id="x-go-title">Go to X profile</title>
								<path
									strokeLinecap="round"
									strokeLinejoin="round"
									d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"
